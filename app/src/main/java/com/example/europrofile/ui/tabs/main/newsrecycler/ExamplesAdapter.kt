...
class ExamplesAdapter: RecyclerView.Adapter<ExamplesAdapter.ExampleVH>() {
    ...
    private val list = arrayListOf(Image("https://firebasestorage.googleapis.com/v0/b/europrofile-b9677.appspot.com/o/ex_1.jpg?alt=media&token=6ec18528-4d72-4cf8-a454-e58e8d36ba42"),
